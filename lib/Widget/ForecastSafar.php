...
class ForecastSafar extends ModuleWidget
{
    const API_ENDPOINT = 'https://api.pune.safar.tropmet.res.in:9091/forecast/';

    private $resourceFolder;
    protected $codeSchemaVersion = 1;

    /**
     * ForecastSafar constructor.
     */
    public function init()
    {
        $this->resourceFolder = PROJECT_ROOT . '/web/modules/forecastsafar';
    ...
    public function installOrUpdate($moduleFactory)
    {
        if ($this->module == null) {
            ...
            $module->name = 'Weather';
            $module->type = 'forecastsafar';
            $module->class = 'Xibo\Widget\ForecastSafar';
            $module->description = 'Weather Powered by SAFAR';
    ...
    {
        return 'forecastsafar-form-settings';
    }
    ...
    private function loadTemplates()
    {
        ...
        foreach (glob(PROJECT_ROOT . '/modules/forecastsafar/*.template.json') as $template) {
    ...
    /**
     * Units supported by Forecast SAFAR API
    ...
    /**
     * Languages supported by Forecast SAFAR API
    ...
    public function getResource($displayId = 0)
    {
        ...
        $styleSheet = $this->makeSubstitutions([
            'cloudy-image' => $this->getResourceUrl('forecastsafar/wi-cloudy.jpg'),
            'day-cloudy-image' => $this->getResourceUrl('forecastsafar/wi-day-cloudy.jpg'),
            'day-sunny-image' => $this->getResourceUrl('forecastsafar/wi-day-sunny.jpg'),
            'fog-image' => $this->getResourceUrl('forecastsafar/wi-fog.jpg'),
            'hail-image' => $this->getResourceUrl('forecastsafar/wi-hail.jpg'),
            'night-clear-image' => $this->getResourceUrl('forecastsafar/wi-night-clear.jpg'),
            'night-partly-cloudy-image' => $this->getResourceUrl('forecastsafar/wi-night-partly-cloudy.jpg'),            
            'rain-image' => $this->getResourceUrl('forecastsafar/wi-rain.jpg'),
            'snow-image' => $this->getResourceUrl('forecastsafar/wi-snow.jpg'),
            'windy' => $this->getResourceUrl('forecastsafar/wi-windy.jpg'),
          ], $this->getRawNode('styleSheet', null)
        );

        $headContent = '
            <link href="' . $this->getResourceUrl('vendor/bootstrap.min.css')  . '" rel="stylesheet" media="screen">
            <link href="' . $this->getResourceUrl('forecastsafar/weather-icons.min.css') . '" rel="stylesheet" media="screen">
            <link href="' . $this->getResourceUrl('forecastsafar/font-awesome.min.css')  . '" rel="stylesheet" media="screen">
            <link href="' . $this->getResourceUrl('forecastsafar/animate.css')  . '" rel="stylesheet" media="screen">
        ...
        $data['head'] = str_replace('[[ICONS]]', $this->getResourceUrl('forecastsafar/' . $this->getOption('icons')), $headContent);
